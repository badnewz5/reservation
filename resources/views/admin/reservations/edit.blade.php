    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.menus.index')}}" class="px-4 py-2 bg-indigo-500 hover:bg-indingo-700 rounded-lg text-white">Reservation</a>
            </div>
            <div class="">
                    ...
                    <div class="container mx-auto">
                        <form method="POST" action="{{ route('admin.reservations.update', $reservation->id)}}" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="res_date" class="w-full py-2 rounded" value="{{$reservation->res_date->format('Y-m-d\TH:i:s') }}">
                                @error('res_date')
                                <span class="text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mt-8">
                                ...
                                <select id="table_id" name="table_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <option value="{{$table->id}}" @selected($table->table_id == $reservation->id)>
