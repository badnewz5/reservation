<x-guest-layout>
    <div class="container w-full px-5 py-6 mx-auto pt-10">
              ...
              <div class="flex flex-col md:flex-row">
                ...
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                  <div class="w-full">
                    ...
                    <div class="mb-4">
                        <label class="block mb-2 text-sm">Reservation Date </label>
                        <input
                          class="
                            w-full
                            px-4
                    ...
                    <div class="mb-4">
                        <label class="block mb-2 text-sm"> Guest Number </label>
                        <input
                          class="
                            w-full
                            px-4
