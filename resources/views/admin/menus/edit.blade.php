                    ...
                    <div class="container mx-auto">
                        <form method="POST" action="{{ route('admin.menus.update', $menu->id)}}" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" class="w-full py-2 rounded" value="{{$menu->name}}">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="number" min="0.00" max="100000.00" step="0.01" name="price" class="w-full py-2 rounded" value="{{$menu->price}}">
                                @error('price')
                                <span class="text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" min="0.00" name="quantity" class="w-full py-2 rounded" value="{{$menu->quantity}}">
                                @error('quantity')
                                <span class="text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
